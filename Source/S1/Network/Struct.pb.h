...
inline float ObjectInfo::_internal_maxhp() const {
  return _impl_.maxhp_;
}
inline float ObjectInfo::maxhp() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectInfo.maxhp)
  return _internal_maxhp();
}
inline void ObjectInfo::_internal_set_maxhp(float value) {
  
  _impl_.maxhp_ = value;
}
inline void ObjectInfo::set_maxhp(float value) {
