...
PROTOBUF_CONSTEXPR C_DEAD::C_DEAD(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.info_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct C_DEADDefaultTypeInternal {
  PROTOBUF_CONSTEXPR C_DEADDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~C_DEADDefaultTypeInternal() {}
  union {
    C_DEAD _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 C_DEADDefaultTypeInternal _C_DEAD_default_instance_;
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ATTACK, _impl_.hit_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ATTACK, _impl_.target_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ATTACK, _impl_.hit_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ATTACK, _impl_.target_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ATTACK, _impl_.rest_hp_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_DEAD, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_DEAD, _impl_.info_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 69, -1, -1, sizeof(::Protocol::C_ATTACK)},
  { 78, -1, -1, sizeof(::Protocol::S_ATTACK)},
  { 88, -1, -1, sizeof(::Protocol::C_DEAD)},
  { 95, -1, -1, sizeof(::Protocol::S_DEAD)},
  { 102, -1, -1, sizeof(::Protocol::C_CHAT)},
  { 109, -1, -1, sizeof(::Protocol::S_CHAT)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_C_DEAD_default_instance_._instance,
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "S_MOVE\022\037\n\004info\030\001 \001(\0132\021.Protocol.PosInfo\""
  "K\n\010C_ATTACK\022\"\n\004info\030\001 \001(\0132\024.Protocol.Obj"
  "ectInfo\022\013\n\003hit\030\002 \001(\010\022\016\n\006target\030\003 \001(\004\"\\\n\010"
  "S_ATTACK\022\"\n\004info\030\001 \001(\0132\024.Protocol.Object"
  "Info\022\013\n\003hit\030\002 \001(\010\022\016\n\006target\030\003 \001(\004\022\017\n\007res"
  "t_hp\030\004 \001(\002\",\n\006C_DEAD\022\"\n\004info\030\001 \001(\0132\024.Pro"
  "tocol.ObjectInfo\",\n\006S_DEAD\022\"\n\004info\030\001 \001(\013"
  "2\024.Protocol.ObjectInfo\"\025\n\006C_CHAT\022\013\n\003msg\030"
...
C_ATTACK::C_ATTACK(const C_ATTACK& from)
  ...
  ::memcpy(&_impl_.target_, &from._impl_.target_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.hit_) -
    reinterpret_cast<char*>(&_impl_.target_)) + sizeof(_impl_.hit_));
...
uint8_t* C_ATTACK::_InternalSerialize(
  ...
  if (this->_internal_hit() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_hit(), target);
  }

  // uint64 target = 3;
  if (this->_internal_target() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(3, this->_internal_target(), target);
  }
...
void C_ATTACK::InternalSwap(C_ATTACK* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(C_ATTACK, _impl_.hit_)
      + sizeof(C_ATTACK::_impl_.hit_)
...
S_ATTACK::S_ATTACK(const S_ATTACK& from)
  ...
  ::memcpy(&_impl_.target_, &from._impl_.target_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.rest_hp_) -
    reinterpret_cast<char*>(&_impl_.target_)) + sizeof(_impl_.rest_hp_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.S_ATTACK)
  ...
  _impl_.info_ = nullptr;
  ::memset(&_impl_.target_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.rest_hp_) -
      reinterpret_cast<char*>(&_impl_.target_)) + sizeof(_impl_.rest_hp_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 37)) {
          _impl_.rest_hp_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_ATTACK::_InternalSerialize(
  ...
  float tmp_rest_hp = this->_internal_rest_hp();
  uint32_t raw_rest_hp;
  memcpy(&raw_rest_hp, &tmp_rest_hp, sizeof(tmp_rest_hp));
  if (raw_rest_hp != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(4, this->_internal_rest_hp(), target);
  }
...
void S_ATTACK::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_rest_hp = from._internal_rest_hp();
  uint32_t raw_rest_hp;
  memcpy(&raw_rest_hp, &tmp_rest_hp, sizeof(tmp_rest_hp));
  if (raw_rest_hp != 0) {
    _this->_internal_set_rest_hp(from._internal_rest_hp());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void S_ATTACK::InternalSwap(S_ATTACK* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_ATTACK, _impl_.rest_hp_)
      + sizeof(S_ATTACK::_impl_.rest_hp_)
...
class C_DEAD::_Internal {
 public:
  static const ::Protocol::ObjectInfo& info(const C_DEAD* msg);
};

const ::Protocol::ObjectInfo&
C_DEAD::_Internal::info(const C_DEAD* msg) {
  return *msg->_impl_.info_;
}
void C_DEAD::clear_info() {
  if (GetArenaForAllocation() == nullptr && _impl_.info_ != nullptr) {
    delete _impl_.info_;
  }
  _impl_.info_ = nullptr;
}
C_DEAD::C_DEAD(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.C_DEAD)
}
C_DEAD::C_DEAD(const C_DEAD& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  C_DEAD* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.info_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.C_DEAD)
}

inline void C_DEAD::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
C_DEAD::~C_DEAD() {
  // @@protoc_insertion_point(destructor:Protocol.C_DEAD)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void C_DEAD::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.info_;
}

void C_DEAD::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void C_DEAD::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.C_DEAD)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* C_DEAD::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* C_DEAD::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.C_DEAD)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.C_DEAD)
  return target;
}

size_t C_DEAD::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_DEAD)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData C_DEAD::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    C_DEAD::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*C_DEAD::GetClassData() const { return &_class_data_; }


void C_DEAD::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<C_DEAD*>(&to_msg);
  auto& from = static_cast<const C_DEAD&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.C_DEAD)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void C_DEAD::CopyFrom(const C_DEAD& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.C_DEAD)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool C_DEAD::IsInitialized() const {
  return true;
}

void C_DEAD::InternalSwap(C_DEAD* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.info_, other->_impl_.info_);
}

::PROTOBUF_NAMESPACE_ID::Metadata C_DEAD::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::C_DEAD*
Arena::CreateMaybeMessage< ::Protocol::C_DEAD >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::C_DEAD >(arena);
}
